...
# Open image
imgDir = os.listdir("drive/MyDrive/DNN/Hw4/test/")

for eachIMG in imgDir:
    image = Image.open("drive/MyDrive/DNN/Hw4/test/" + eachIMG).convert("YCbCr")
